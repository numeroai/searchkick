module Searchkick
  class IndexOptions
    ...
    def generate_settings
      ...
      if options[:knn]
        unless Searchkick.knn_support?(index.client)
          if Searchkick.opensearch?(index.client)
        ...
        if Searchkick.opensearch?(index.client) && options[:knn].any? { |_, v| !v[:distance].nil? }
